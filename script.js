const autoresPorEstado = {
    ...
    "Bahia": ["Itamar Vieira Junior", "Jorge Amado", "Castro Alves", "Rui Barbosa", "Gregório de Matos", "João Ubaldo Ribeiro", "Myriam Fraga", "Jacinta Passos", "Adonias Filho"],
    "Ceará": ["Socorro Acioli", "Rachel de Queiroz", "José de Alencar", "Patativa do Assaré", "Ana Miranda", "Juvenal Galeno", "Jáder de Carvalho"],
